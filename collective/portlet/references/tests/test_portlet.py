...
class TestPortlet(TestCase):
    ...
    def test_portlet_type_registered(self):
        portlet = getUtility(IPortletType, name='collective.portlet.references.ReferencesPortlet')
        self.assertEquals(portlet.addview, 'collective.portlet.references.ReferencesPortlet')
    ...
    def test_invoke_add_view(self):
        ...
        self.failUnless(isinstance(mapping.values()[0], referencesportlet.Assignment))
...
class TestRenderer(TestCase):
    ...
    def test_render(self):
        # TODO: Pass any keyword arguments to the Assignment constructor
        r = self.renderer(context=self.portal, assignment=referencesportlet.Assignment())
